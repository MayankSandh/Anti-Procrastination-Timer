...
def displayNotification(timeTitle, displayedMessage, shutdownMode):
    from plyer import notification
    notification.notify(
        title = timeTitle,
...
class TimerTiles(Button):
    ...
    # def changeTheme(self, defaultbg, hoverbg, hoverfg, activebg, activefg):
    #     self.defaultbg = defaultbg
    #     self.hoverbg = hoverbg
    #     self.hoverfg = hoverfg
    #     self.activebg = activebg
...
with open("theme/changeDefaultTheme.txt", "r") as file:
